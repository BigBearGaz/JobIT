 ...
 */
final class Version20241024195812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre ADD auteur INT NOT NULL, CHANGE durée duree VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre DROP auteur, CHANGE duree durée VARCHAR(255) DEFAULT NULL');
    }
}
