 ...
 */
final class Version20241104101527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, type_contrat_id INT NOT NULL, category_id INT NOT NULL, auteur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_publication DATE NOT NULL, date_modification DATE NOT NULL, lieu VARCHAR(255) NOT NULL, duree VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) NOT NULL, INDEX IDX_AF86866F520D03A (type_contrat_id), INDEX IDX_AF86866F12469DE2 (category_id), INDEX IDX_AF86866F60BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
